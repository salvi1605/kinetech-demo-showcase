...
BEGIN
  ...
  -- 4. Calcular sub_slot: usar el proporcionado por el usuario, o buscar libre
  ...
  IF v_date_or_time_changed THEN
    ...
    IF p_sub_slot IS NOT NULL THEN
      -- Usuario eligió un sub-slot específico: validar que esté libre
    ...
    ELSE
      -- Auto-asignar primer sub-slot libre
      v_free_slot := NULL;
